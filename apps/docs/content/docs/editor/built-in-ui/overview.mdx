...
happens when a person activates a link. **Context menu** covers right-click actions. The **Content controls** guide
covers `ui.contentControls`. **Layout** covers `ui.ruler` alongside the Editor's zoom and responsive shell.
