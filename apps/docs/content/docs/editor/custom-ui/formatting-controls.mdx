...
Next, [build a comments workflow](/editor/custom-ui/comments) to apply the same loop to a list of document entities and
their actions. Use [Custom commands](/editor/custom-ui/custom-commands) later for application actions that SuperDoc does
not provide.
