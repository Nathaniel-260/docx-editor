...
This page builds a hybrid interface: React renders the toolbar, and the remaining built-in surfaces stay at their defaults because the example passes no `ui`. [Choose your interface](/editor/who-renders-the-ui) compares the built-in, hybrid, and custom approaches.
