...
session. Next, [build an application-owned context menu](/editor/custom-ui/context-menus) for actions that depend on the
entity or selection under the pointer.
