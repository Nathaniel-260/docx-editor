...
const REMOVED_SUBPATHS: MigrationEntry[] = [
  ...
  },
  {
    ...
    symptom: 'Module resolution fails; the subpath is absent from the v2 exports map.',
    notes:
      'Composables moved and now bind to the instance-owned controller. Provide it once with `provideSuperDocUI()`, then read slices with the `useSuperDoc*` composables.',
    docsPath: '/editor/custom-ui/overview',
  },
];
